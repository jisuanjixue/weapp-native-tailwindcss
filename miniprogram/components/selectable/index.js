...
import { isPresetColor } from '../../behaviors/colors';
...
baseComponent({
    ...
    computed: {
        classes: [
            'prefixCls, inputChecked, disabled, readOnly',
            function (prefixCls, inputChecked, disabled, readOnly) {
    ...
    methods: {
        ...
        onChange() {
            const { value, inputChecked, disabled, readOnly, controlled } =
                this.data;
            const item = {
