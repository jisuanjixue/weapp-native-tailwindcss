...
baseComponent({
    ...
    computed: {
        classes: [
            'prefixCls, hoverClass, bordered, full, actions',
            function (prefixCls, hoverClass, bordered, full, _actions) {
                ...
                const action = _actions.map((action) => {
                    const wrap = classNames(`${prefixCls}__action`, {
                        [`${prefixCls}__action--${action.type || 'default'}`]:
                            action.type || 'default',
                    ...
                    const hover =
                        action.hoverClass && action.hoverClass !== 'default'
                            ? action.hoverClass
